...
#define LFUNKCG LT(_FUNNAV, KC_G)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NORMAN] = LAYOUT(
        ...
        KC_LCTL, KC_A   , KC_S   , KC_E   , KC_T   , LFUNKCG,                                         KC_Y   , KC_N   , KC_I   , KC_O   , KC_H   , CTL_QUO,
        KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_ENT , KC_BSPC,     KC_BSLS, KC_ESC , KC_P   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, SC_SENT,
                                   LFUNRBK, KC_LALT, KC_LCMD, KC_SPC , TNUMNAV,     TSYMNAV, TNUMNAV, CMD_MIN, ALT_EQL, LFUNSPC
    ),

    [_QWERTY] = LAYOUT(
        KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   ,                                         KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_LBRC,
        KC_LCTL, KC_A   , KC_S   , KC_D   , KC_F   , LFUNKCG,                                         KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, CTL_QUO,
    ...
    [_FUNNAV] = LAYOUT(
        KC_TILD, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,                                         MS_WHLD, MS_BTN1, MS_UP  , MS_BTN2, XXXXXXX, XXXXXXX,
        _______, KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 ,                                         MS_WHLU, MS_LEFT, MS_DOWN, MS_RGHT, _______, _______,
        _______, KC_BRID, KC_BRIU, KC_F11 , KC_F12 , KC_CAPS, NORMAN , QWERTY ,     _______, _______, _______, MS_BTN1, MS_BTN3, MS_BTN2, _______, _______,
                                   _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______
        //
